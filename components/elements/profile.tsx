        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="mb-4 flex items-center">
              <span className="bg-gray-300 text-gray-600 border border-gray-300 px-4 py-2 rounded-l-md">Twitter</span>
              <input type="text" className="w-full border border-gray-300 px-4 py-2 border-l-0 rounded-r-md" placeholder="username" />
            </div>
            <div className="mb-4 flex items-center">
              <span className="bg-gray-300 text-gray-600 px-4 py-2 border border-gray-300 rounded-l-md">Linkedin</span>
              <input type="text" className="w-full px-4 py-2 border border-gray-300 border-l-0 rounded-r-md" placeholder="username" />
            </div>
            <div className="mb-4 flex items-center">
              <span className="bg-gray-300 text-gray-600 px-4 py-2 border border-gray-300 rounded-l-md">ENS</span>
              <input type="text" className="w-full px-4 py-2 border border-gray-300 border-l-0 rounded-r-md" placeholder="username" />
            </div>
          </div>
        </div>
